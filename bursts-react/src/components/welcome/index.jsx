...
import Engineer from '../../assets/images/undraw_new_ideas_jdea.svg';
...
function Welcome() {
  ...
  return (
    <div className="welcome-page flex-column align-items-center justify-content-center text-center text-white p-5">
      ...
      <img src={Engineer} width="500" className="mt-5" alt="Engineer coming up with a new idea" />
      <p className="lead mt-5">Are you ready for another burst?</p>
      <div className="mt-3">
        <button
          type="button"
          onClick={() => {
