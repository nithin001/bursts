...
import { updateBurstNotified, createBurst } from '../../redux/actions';

import { getBurstState } from '../../redux/selectors';
import './burst_notification.scss';

import Engineer from '../../assets/images/undraw_High_five_u364.svg';
    ...
    <div className="burst-notification flex-column align-items-center justify-content-center text-center text-white p-5">
      <div className="row align-items-center justify-content-center">
        <div className="col-9 ">
          ...
          <img src={Engineer} width="500" className="mt-5" alt="Two people high fiving as a celebration" />
          <p className="lead mt-3">You deserve a hard earned break. Go for it!</p>
          <div className="mt-5">
            <button
              type="button"
              onClick={() => {
